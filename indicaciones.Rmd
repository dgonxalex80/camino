...
* Presentación del tema:
  * Monición ambiental 
  * Para cada lectura: Proclamación / Canto de respuesta a la palabra
  * Oraciones
  * Padre Nuestro
  * Saludo de paz
  * Bendición final
...
#### **Nota**: 
  ...
  * No se hace ecos
  * Debido a que se termina tarde, se autorizó hacer una buena monición ambiental y **lecturas y canto** solamente  (sin moniciones).  
...
* Celebración :
  ...
  * Catequesis - se divide en dos: 1 Catequesis 2. Como este tema ha tocado mi vida - testimios, experiencias de vida.
...
* La respuesta a la encuesta se realiza de manera oral
